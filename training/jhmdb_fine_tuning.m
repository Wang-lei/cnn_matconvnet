...
for split = 1:1
    ...
    opts.dataDir = sprintf('/tmp/JHMDB/cnn_OF/%s/resized227',opts.part) ;
    %opts.dataDir = sprintf('/home/local/gcheron/datasets/JHMDB/cnn_OF/%s/resized227',opts.part) ;
    opts.originalProposalDataDir = '/tmp/JHMDB/cnn_OF/full_image';
